          ...
          <div class="seccion">
            ...
            <div class="card">
              <div class="card-header">
                <h2>Creacion Cuenta Corriente</h2>
              </div>
              <div class="card-body">
                <form id="creacionCuentaCorriente">
                  ...
                  <div class="form-group d-grid gap-2">
                    <input id="cuentacorriente" value="Crear" onClick="creacionCuentaCorriente();" type="submit" value="Enviar" class="btn btn-outline-primary btn-lg" />
                  </div>
                  <script>
                    document.getElementById('creacionCuentaCorriente').addEventListener('click', function(event) {
                    ...
                    <div class="card">
                      <form id="depositar">
                        <div class="form-group-actions">
                          ...
                          <input type="text" id="cantidadDeposito" name="cantidad" class="form-control" placeholder="Saldo Deposito" required pattern="[0-9]+">
                        </div>

                        <div class="form-group-actions">
                          <button class="btn btn-success btn-md" value="depositar" onClick="depositarcuentacorriente();">Depositar</button>
                        </div>
                      </form>
                      <script>
                  ...
                  <div class="col-md-6 p-2">
                    <div class="card">
                      <form id="retirar">
                        <div class="form-group-actions">
                          <label for="nombre">Cantidad:</label>
                          <input type="text" id="cantidadRetiro" name="cantidad" class="form-control" placeholder="Saldo Retiro" required pattern="[0-9]+">
                        </div>

                        <div class="form-group-actions">
                          <button class="btn btn-danger btn-md" value="retirar" onClick="retirarcuentacorriente();">Retirar</button>
                        </div>
                      </form>
                      <script>
                ...
                <div class="row mt-3">
                  <div class="col">
                    <div class="card">
                      <form id="consultar">
                        <div class="form-group d-grid gap-2">
                          <button class="btn btn-primary btn-md" value="consultar" onClick="consultarcuentacorriente();">consultar Saldo</button>
                        </div>
                      </form>
                      <script>
